function displayElements() {
    ...
    var h1graduationEmojis = document.createElement('h1');
    h1graduationEmojis.style.fontSize = '325px';
    h1graduationEmojis.style.margin = '20px';
    h1graduationEmojis.style.padding = '10px';
    document.getElementById('landingPage').appendChild(h1graduationEmojis);

    var emojis2 = ['🥂', '🎓', '🎊', '🧑‍🎓', '👩‍🎓', '🤓', '📚'];
    var currentIndex2 = 0;

    function updateGraduationEmojis() {
        h1graduationEmojis.textContent = emojis2[currentIndex2];
        currentIndex2 = (currentIndex2 + 1) % emojis2.length;
    }

    updateGraduationEmojis();

    var intervalId2 = setInterval(updateGraduationEmojis, 1000);
    ...
    document.getElementById('submitButton').addEventListener('click', function() {
        ...
        if (guess === 'graduation') {
            var correctGifUrl = 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExYjZqZ2YyeDJkMm5haHJ6cXkxcTd6aDBzdjZzd20xcjhqcHl0anhrOCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/uVpPvvpU3nip5pBkPD/giphy.gif';
            displayGifWithButton(correctGifUrl, 'Next');
        } else {
            var incorrectGifUrl = 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExeDRyOHRiYnZ4d3dvcnJ3bjQxOXJiZm1iZDJ1bTRuYnp0YjZnN2U1NyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/xVIkfXYGTJeZKilg3p/giphy.gif';
