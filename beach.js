function displayElements() {
    ...
    var h1beachEmojis = document.createElement('h1');
    h1beachEmojis.style.fontSize = '325px';
    h1beachEmojis.style.margin = '20px';
    h1beachEmojis.style.padding = '10px';
    document.getElementById('landingPage').appendChild(h1beachEmojis);

    var emojis2 = ['🏖️', '🐚', '🏊', '🏝️', '🏄', '🐬', '🌞'];
    var currentIndex2 = 0;

    function updateBeachEmojis() {
        h1beachEmojis.textContent = emojis2[currentIndex2];
        currentIndex2 = (currentIndex2 + 1) % emojis2.length;
    }

    updateBeachEmojis();

    var intervalId2 = setInterval(updateBeachEmojis, 1000);
    ...
    document.getElementById('submitButton').addEventListener('click', function() {
        ...
        if (guess === 'beach') {
            var correctGifUrl = 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExbHNmYWl0bTcyZ3I1bmprb3pmbTI4eWh4bzB3eGprcWh6MDh6Mjl4ayZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/jzaZ23z45UxK8/giphy.gif';
            displayGifWithButton(correctGifUrl, 'Next');
        } else {
            var incorrectGifUrl = 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExeGhmZXYyMWgyc2MyZHRhNzNsYnRneHVpcnRkbXcxNnBuNGt3ZnB1ciZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/3o7aD4XavHnL5UsWEE/giphy.gif';
    ...
    function displayGifWithButton(gifUrl, buttonText) {
        ...
        button.addEventListener('click', function() {
            if (buttonText === 'Next') {
                window.location.href = 'rainbow.html';
            } else {
