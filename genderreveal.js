function displayElements() {
    ...
    var h1genderrevealEmojis = document.createElement('h1');
    h1genderrevealEmojis.style.fontSize = '325px';
    h1genderrevealEmojis.style.margin = '20px';
    h1genderrevealEmojis.style.padding = '10px';
    document.getElementById('landingPage').appendChild(h1genderrevealEmojis);

    var emojis2 = ['👶', '🎉', '🎀', '💙', '👧', '👦', '🤰🏻'];
    var currentIndex2 = 0;

    function updategenderRevealEmojis() {
        h1genderrevealEmojis.textContent = emojis2[currentIndex2];
        currentIndex2 = (currentIndex2 + 1) % emojis2.length;
    }

    updategenderRevealEmojis();

    var intervalId2 = setInterval(updategenderRevealEmojis, 1000);
    ...
    document.getElementById('submitButton').addEventListener('click', function() {
        ...
        if (guess === 'gender reveal' || guess === 'baby shower') {
            var correctGifUrl = 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExYnhvcHE1Z3QyZzcwdm83cGk0bGxoZDNpajdkcHlrNm11cTExbm5zZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/artj92V8o75VPL7AeQ/giphy.gif';
            displayGifWithButton(correctGifUrl, 'Claim Prize');
        } else {
            var incorrectGifUrl = 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExdWJwZTNpNGY4dmQ1dHMwZ2s0ZTQ1NG02bTd6MW42Njlxd3RnZDNobiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/3o7TKGVqdQdyGb3aDe/giphy-downsized-large.gif';
