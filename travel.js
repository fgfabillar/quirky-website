function displayElements() {
    ...
    var h1travelEmojis = document.createElement('h1');
    h1travelEmojis.style.fontSize = '325px';
    h1travelEmojis.style.margin = '20px';
    h1travelEmojis.style.padding = '10px';
    document.getElementById('landingPage').appendChild(h1travelEmojis);

    var emojis2 = ['🧳', '🛳️', '🗺️', '🌍', '🚂', '🚗', '🛄'];
    var currentIndex2 = 0;

    function updateTravelEmojis() {
        h1travelEmojis.textContent = emojis2[currentIndex2];
        currentIndex2 = (currentIndex2 + 1) % emojis2.length;
    }

    updateTravelEmojis();

    var intervalId2 = setInterval(updateTravelEmojis, 1000);
    ...
    document.getElementById('submitButton').addEventListener('click', function() {
        ...
        if (guess === 'travel') {
            var correctGifUrl = 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExMmRiN3I4emFhNWk2cWQyYm04OTJrdTl6YTc4ODQwaWxlY2l1b211OCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/AEz13dFnwqEtohu3u0/giphy.gif';
            displayGifWithButton(correctGifUrl, 'Next');
        } else {
            var incorrectGifUrl = 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExaWJyZTV5NDcxbHMxd285eW85djNleHFrbG5ld2J2MHA3MDlmdWg1ZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/rvDtLCABDMaqY/giphy.gif';
