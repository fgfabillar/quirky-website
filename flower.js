function displayElements() {
    ...
    var h1flowerEmojis = document.createElement('h1');
    h1flowerEmojis.style.fontSize = '325px';
    h1flowerEmojis.style.margin = '20px';
    h1flowerEmojis.style.padding = '10px';
    document.getElementById('landingPage').appendChild(h1flowerEmojis);

    var emojis2 = ['🌼', '🌻', '🌸', '🌹', '🌷', '🌺', '🪷'];
    var currentIndex2 = 0;

    function updateFlowerEmojis() {
        h1flowerEmojis.textContent = emojis2[currentIndex2];
        currentIndex2 = (currentIndex2 + 1) % emojis2.length;
    }

    updateFlowerEmojis();

    var intervalId2 = setInterval(updateFlowerEmojis, 1000);
    ...
    document.getElementById('submitButton').addEventListener('click', function() {
        ...
        if (guess === 'flower') {
            var correctGifUrl = 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExazFoNWg5bXJlM3ZlM3pkdTNyM2RmemE0NXFpNjVyYmp0eTNjbG94dCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/xUPN3arbbCrB7kcZ1e/giphy.gif';
            displayGifWithButton(correctGifUrl, 'Next');
        } else {
            var incorrectGifUrl = 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExZjZ1M3NzcGExcnNteTJ6NXM5Nnl1aWVrdm13b3gwNHphazJnYnpxZSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/xT1R9TtHD4gvFTXRks/giphy.gif';
