function displayElements() {
    ...
    var h1onlinegameEmojis = document.createElement('h1');
    h1onlinegameEmojis.style.fontSize = '325px';
    h1onlinegameEmojis.style.margin = '20px';
    h1onlinegameEmojis.style.padding = '10px';
    document.getElementById('landingPage').appendChild(h1onlinegameEmojis);

    var emojis2 = ['🎮', '👾', '🕹️', '🤖', '🖥️', '📱', '🛜'];
    var currentIndex2 = 0;

    function updateOnlinegameEmojis() {
        h1onlinegameEmojis.textContent = emojis2[currentIndex2];
        currentIndex2 = (currentIndex2 + 1) % emojis2.length;
    }

    updateOnlinegameEmojis();

    var intervalId2 = setInterval(updateOnlinegameEmojis, 1000);
    ...
    document.getElementById('submitButton').addEventListener('click', function() {
        ...
        if (guess === 'online game' || guess === 'game') {
            var correctGifUrl = 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExZTB0MjNkcnFwOXM5bXlwcnppbnRneDl5Y2J4ZDhya3J6aWd1YnRkNyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/DhstvI3zZ598Nb1rFf/giphy-downsized-large.gif';
            displayGifWithButton(correctGifUrl, 'Next');
        } else {
            var incorrectGifUrl = 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExZmdwOW00cWN3eDR4anJqdXNud3BtZWx5Z3p0ejF1OHl5ejk4bmR4ZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/O0qqW2fCK3NCaVhugy/giphy.gif';
    ...
    function displayGifWithButton(gifUrl, buttonText) {
        ...
        button.addEventListener('click', function() {
            if (buttonText === 'Next') {
                window.location.href = "genderreveal.html";
            } else {
