function displayElements() {
    ...
    var h1musicEmojis = document.createElement('h1');
    h1musicEmojis.style.fontSize = '325px';
    h1musicEmojis.style.margin = '20px';
    h1musicEmojis.style.padding = '10px';
    document.getElementById('landingPage').appendChild(h1musicEmojis);

    var emojis2 = ['🎤', '🎵', '🎸', '🥁', '🎹', '🎶', '🎺'];
    var currentIndex2 = 0;

    function updateMusicEmojis() {
        h1musicEmojis.textContent = emojis2[currentIndex2];
        currentIndex2 = (currentIndex2 + 1) % emojis2.length;
    }

    updateMusicEmojis();

    var intervalId2 = setInterval(updateMusicEmojis, 1000);
    ...
    document.getElementById('submitButton').addEventListener('click', function() {
        ...
        if (guess === 'music' || guess === 'musical instrument' || guess === 'musical instruments') {
            var correctGifUrl = 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExeW04bm85ZnFsYnV6aHZjMTF4ZDdodXJhOHk3OHhxc3RtOHYxangxeCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/qrIsXgEdorkI/giphy.gif';
            displayGifWithButton(correctGifUrl, 'Next');
        } else {
            var incorrectGifUrl = 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExYjFraXJnODNnaGhnemh0NDBzNzMyZGd0NmhjODMwOXRhOHprOXF2eSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/ftqLysT45BJMagKFuk/giphy.gif';
